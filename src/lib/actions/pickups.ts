...
export async function createPickupRequest(data: {
  ...
  try {
    ...
    return { success: false, message: "Failed to request pickup" }
  }
}
...
export async function approvePickup(
  ...
  try {
    ...
    return { success: false, message: "Failed to approve pickup" }
  }
}
...
export async function rejectPickup(
  ...
  try {
    ...
    return { success: false, message: "Failed to reject pickup" }
  }
}
